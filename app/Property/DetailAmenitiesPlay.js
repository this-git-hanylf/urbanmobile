...
class DetailAmenitiesPlay extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      amenitis_title: "",
      ...
      amenitis_url: "",
      stat: "Y",
      gallery_1: require("@Asset/images/amenitis/play/gallery1.jpg"),
      gallery_2: require("@Asset/images/amenitis/play/gallery2.jpg"),
  ...
  getDataAminities = () => {
    ...
    console.log("item tower", item);
    {
      isMount
        ? fetch(
            urlApi +
              "c_reservation/getDataDetailsAmenitiesPlay/" +
              item.db_profile +
              "/" +
              item.entity_cd +
              "/" +
...
export default DetailAmenitiesPlay;
