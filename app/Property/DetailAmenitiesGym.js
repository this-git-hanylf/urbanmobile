...
class DetailAmenitiesGym extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      amenitis_title: "",
      ...
      amenitis_url: "",
      stat: "G",
      gallery_1: require("@Asset/images/amenitis/gym/gallery1.jpg"),
      gallery_2: require("@Asset/images/amenitis/gym/gallery2.jpg")
  ...
  getDataAminities = () => {
    ...
    console.log("item tower", item);
    {
      isMount
        ? fetch(
            urlApi +
              "c_reservation/getDataDetailsAmenitiesGym/" +
              item.db_profile +
              "/" +
              item.entity_cd +
              "/" +
...
export default DetailAmenitiesGym;
